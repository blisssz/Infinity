...
Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf NoLighting finalcolor:mycolor
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			half4 c1 = tex2D (_Noise1Tex, IN.worldPos.xz/ float2(_repeatFac1x, _repeatFac1z) + _translate1);//uv_Noise1Tex);
			//o.Albedo = c.rgb;
			//o.Alpha = c.a;
