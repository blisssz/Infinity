...
public class Lava : MonoBehaviour {
	...
	private void translateLava(){
		...
		this.renderer.material.SetFloat("_tr1x", translated1.x);
		this.renderer.material.SetFloat("_tr1y", translated1.y);

		translated2 += translate2amount*translateFac;
		this.renderer.material.SetFloat("_tr2x", translated2.x);
		this.renderer.material.SetFloat("_tr2y", translated2.y);
	}
	...
	private void applyMixFactor(){
		...
		this.renderer.material.SetFloat("_fac",  mix);
	}
